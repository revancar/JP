...
class TvShowFavAdapter: PagedListAdapter<TvShowEntity, TvShowFavAdapter.TvShowViewHolder>
    (DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TvShowFavAdapter.TvShowViewHolder {
        val itemsTvshowBinding = ItemsTvshowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return TvShowViewHolder(itemsTvshowBinding)
    }

    override fun onBindViewHolder(holder: TvShowFavAdapter.TvShowViewHolder, position: Int) {
